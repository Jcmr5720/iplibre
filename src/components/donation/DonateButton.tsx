...
export function DonateButton({ className, onClick, variant = "compact" }: DonateButtonProps) {
  return (
    <Link
      ...
      className={cn(
        "inline-flex items-center justify-center gap-1.5 rounded-lg bg-primary font-semibold text-primary-foreground shadow-sm transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
