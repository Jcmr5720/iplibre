...
export function makeMinimalPe(): Uint8Array {
  ...
  bytes.set(text("PE\0\0"), 0x80); view.setUint16(0x84, 0x8664, true); view.setUint16(0x86, 1, true); view.setUint16(0x94, 0, true);
  bytes.set(text(".text\0\0\0"), 0x98); view.setUint32(0xa8, 256, true); view.setUint32(0xac, 256, true);
  return bytes;
}
